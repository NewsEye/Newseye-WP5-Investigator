"""new database structure: datasets and documents

Revision ID: 3605d2327dc9
Revises: 
Create Date: 2019-12-11 09:49:23.982315
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('solr_id', name='uq_solr_id')
    )
