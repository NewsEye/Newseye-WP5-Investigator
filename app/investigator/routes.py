...
class AnalysisTaskList(Resource):
    ...
    post_parser.add_argument(
        ...
        type=dict,
        location="json",
        help="A JSON object containing a search query that defines the input data for the investigator",
    )
    post_parser.add_argument(
        "source_uuid",
        location="json",
        help="A task_uuid that defines the input data for the investigator",
    )
    post_parser.add_argument(
        "force_refresh",
        type=bool,
...
@ns.param(
    "task_uuid", "The UUID of the investigator task for which results should be retrieved",
)
