...
class GenerateTimeSeries(AnalysisUtility):
    ...
    async def estimate_interestingness(self):
        interestingness = assessment.recoursive_distribution(self.result['relative_counts'])
        return {k : (assessment.normalized_entropy(v.values()),v) for k,v in interestingness.items()}
